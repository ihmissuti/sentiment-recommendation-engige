...
let itemsInStock = [
	{ 
		...
		displayingInformation: { imageFile: 'cl_black_nl_circle_hp_false_prc_1999.png' }	
	},
	{ 
		trainingInformation: { color: color_blue, hasPrinting: 0, neckline: neckline_round, price: 19.99 },
		displayingInformation: { imageFile: 'cl_blue_nl_circle_hp_false_prc_1999.png' } 
	},			
	{ 
		trainingInformation: { color: color_darkblue, hasPrinting: 1, neckline: neckline_round, price: 29.99 }, 
		displayingInformation: { imageFile: 'cl_darkblue_nl_circle_hp_true_prc_2999.png' } 
	},			
	{ 
		trainingInformation: { color: color_gray, hasPrinting: 0, neckline: neckline_v, price: 9.99 }, 
		displayingInformation: { imageFile: 'cl_gray_nl_v_hp_false_prc_999.png' } 
	},			
	// { 
	...
	{ 
		...
		displayingInformation: { imageFile: 'cl_green_nl_circle_hp_false_prc_1799.png' } 
	},			
	{ 
		trainingInformation: { color: color_blue, hasPrinting: 0, neckline: neckline_round, price: 17.99 }, 
		displayingInformation: { imageFile: 'cl_blue_nl_circle_hp_false_prc_1799.png' } 
	},			
	{ 
		trainingInformation: { color: color_turqoise, hasPrinting: 1, neckline: neckline_round, price: 15.99 }, 
		displayingInformation: { imageFile: 'cl_turqoise_nl_circle_hp_true_prc_1599.png' }
	},			
	{ 
		trainingInformation: { color: color_skin, hasPrinting: 1, neckline: neckline_round, price: 15.99 }, 
		displayingInformation: { imageFile: 'cl_skin_nl_circle_hp_true_prc_1599.png' } 
	},			
	{ 
		trainingInformation: { color: color_darkblue, hasPrinting: 1, neckline: neckline_round, price: 15.99 }, 
		displayingInformation: { imageFile: 'cl_darkblue_nl_circle_hp_true_prc_1599.png' } 
	},			
	{ 
		trainingInformation: { color: color_turqoise, hasPrinting: 1, neckline: neckline_round, price: 15.99 }, 
		displayingInformation: { imageFile: 'cl_turqoise_nl_circle_hp_true_prc_1599_1.png' } 
	},			
	{ 
		trainingInformation: { color: color_darkblue, hasPrinting: 1, neckline: neckline_round, price: 15.99 }, 
		displayingInformation: { imageFile: 'cl_darkblue_nl_circle_hp_true_prc_1599_1.png' } 
	},			
	{ 
		trainingInformation: { color: color_lightblue, hasPrinting: 0, neckline: neckline_round, price: 19.99 }, 
		displayingInformation: { imageFile: 'cl_lightblue_nl_circle_hp_false_prc_1999.png' } 
	},			
	{ 
		trainingInformation: { color: color_lightgreen, hasPrinting: 0, neckline: neckline_round, price: 19.99 }, 
		displayingInformation: { imageFile: 'cl_lightgreen_nl_circle_hp_false_prc_1999.png' } 
	},			
	{ 
		trainingInformation: { color: color_skin, hasPrinting: 0, neckline: neckline_round, price: 19.99 }, 
		displayingInformation: { imageFile: 'cl_skin_nl_circle_hp_false_prc_1999.png' } 
	},			
	{ 
		trainingInformation: { color: color_gray, hasPrinting: 0, neckline: neckline_round, price: 19.99 }, 
		displayingInformation: { imageFile: 'cl_gray_nl_circle_hp_false_prc_1999.png' } 
	},			
];